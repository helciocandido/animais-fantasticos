...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ initHandleText)\n/* harmony export */ });\nfunction initHandleText() {\n  var textP = document.querySelectorAll(\"p\");\n  var textDt = document.querySelectorAll(\"dt\");\n  var textDd = document.querySelectorAll(\"dd\");\n  var textLi = document.querySelectorAll(\"li\");\n\n  function handleText(event) {\n    if (event.key === \"t\") {\n      textP.forEach(function (text) {\n        text.classList.toggle(\"textomaior\");\n      });\n      textDt.forEach(function (text) {\n        text.classList.toggle(\"textomaior\");\n      });\n      textDd.forEach(function (text) {\n        text.classList.toggle(\"textomaior\");\n      });\n      textLi.forEach(function (text) {\n        text.classList.toggle(\"textomaior\");\n      });\n    }\n  }\n\n  window.addEventListener(\"keydown\", handleText);\n}\n\n//# sourceURL=webpack://animais-fantasticos/./js/modules/handle-text.js?");
